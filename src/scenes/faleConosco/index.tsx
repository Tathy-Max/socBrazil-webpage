...
const FaleConosco = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="faleconosco" className="mx-auto w-5/6 pt-24 pb-32">
      <motion.div
        onViewportEnter={() => setSelectedPage(SelectedPage.FaleConosco)}
      >
        {/* HEADER */}
        <motion.div
          className="md:w-3/5"
